...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/023_incident_causal_learning.sql"
...
echo 'INCIDENT_CAUSAL_LEARNING_MIGRATION|PASS|encrypted_context=1|external_actions=0|production_writes=0'
