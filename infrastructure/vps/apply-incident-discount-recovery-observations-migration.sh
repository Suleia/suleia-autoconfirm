...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/030_incident_discount_recovery_observations.sql"
...
echo 'INCIDENT_DISCOUNT_RECOVERY_OBSERVATIONS|PASS|external_actions=0'
