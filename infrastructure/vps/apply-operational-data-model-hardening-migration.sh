...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/014_operational_data_model_hardening.sql"
test -r "${ENV_FILE}"
...
echo 'OPERATIONAL_DATA_MODEL_HARDENING_MIGRATION|PASS|actions=0|production_writes=0'
