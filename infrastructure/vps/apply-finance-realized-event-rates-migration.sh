...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/031_finance_realized_event_rates.sql"
...
echo 'FINANCE_REALIZED_EVENT_RATES|PASS|return_per_order=5.26|external_actions=0|production_writes=0'
