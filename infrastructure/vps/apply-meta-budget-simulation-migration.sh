...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/034_meta_budget_simulation.sql"
...
echo 'META_BUDGET_SIMULATION|PASS|mode=simulation_shadow|external_actions=0|production_writes=0|meta_budget_writes=0'
