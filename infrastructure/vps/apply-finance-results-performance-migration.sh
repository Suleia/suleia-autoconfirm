...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/032_finance_results_performance.sql"
...
echo 'FINANCE_RESULTS_PERFORMANCE|PASS|read_model=optimized|external_actions=0|production_writes=0'
