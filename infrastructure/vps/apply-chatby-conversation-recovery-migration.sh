...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/013_chatby_conversation_recovery.sql"
test -r "${ENV_FILE}"
...
echo 'CHATBY_CONVERSATION_RECOVERY_MIGRATION|PASS|actions=0|production_writes=0'
