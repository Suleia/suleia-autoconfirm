...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/020_incident_truth_feedback.sql"
...
echo 'INCIDENT_TRUTH_FEEDBACK_MIGRATION|PASS|structured_feedback=1|external_actions=0|production_writes=0'
