...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/011_operations_readonly_permissions.sql"
...
echo 'OPERATIONS_READONLY_PERMISSIONS|PASS|write_grants=0|actions=0|production_writes=0'
