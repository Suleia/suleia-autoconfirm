...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/029_finance_fixed_expense_deduplication.sql"
...
echo 'FINANCE_FIXED_EXPENSE_DEDUPLICATION_2026_08|PASS|active_total_eur=176.39|external_actions=0'
