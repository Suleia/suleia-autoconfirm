...
MIGRATION_FILE="${INSTALL_ROOT}/migrations/024_financial_control.sql"
...
echo 'FINANCIAL_CONTROL_MIGRATION|PASS|calendar_month=1|daily_ledger=1|external_actions=0|production_writes=0'
