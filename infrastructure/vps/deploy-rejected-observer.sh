...
branch=feat/rejected-canonical-observer
...
backup="/opt/suleia-backups/rejected-observer-$revision"
...
image="suleia-rejected-observer:$revision"
...
docker exec -i suleia-operations-staging-postgres-1 psql -X -v ON_ERROR_STOP=1 -U suleia_admin -d suleia_staging < migrations/048_rejected_owner_observations.sql
