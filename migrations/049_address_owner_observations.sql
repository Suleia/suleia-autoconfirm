BEGIN;
CREATE TABLE operations.address_owner_observations (
...
CREATE VIEW read_models.operations_address_owner_latest AS SELECT * FROM operations.address_owner_observations;
