export function projectRecipientAbsentShadow(item) {
  ...
  return { ...item, policy_id: s.policy_id, policy_version: s.policy_version,policy_snapshot_hash:s.policy_snapshot_hash,
    current_step: s.current_step, next_action: s.next_action, reason_summary: s.reason_text,
    customer_intent: s.customer_intent, waiting_customer: item.waiting_customer ?? s.waiting_customer,
