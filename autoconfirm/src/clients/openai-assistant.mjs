...
- Si un pedido de Dropea supera 48 horas sin confirmacion clara y sin cambio de direccion/datos, no lo confirmes ni lo dejes esperando: la regla operativa es rechazarlo/cancelarlo automaticamente en Dropea.
