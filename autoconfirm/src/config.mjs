...
export function getAppConfig() {
  ...
  return {
    ...
    testPhoneBlockEnabled: bool(process.env.TEST_PHONE_BLOCK_ENABLED, true),
    testPhoneNormalized: process.env.TEST_PHONE_NORMALIZED || null,
    duplicateOrderDetectionEnabled: bool(process.env.DUPLICATE_ORDER_DETECTION_ENABLED, true),
    duplicateOrderBlockingEnabled: bool(process.env.DUPLICATE_ORDER_BLOCKING_ENABLED, false),
    chatbyContactCleanupPreviewEnabled: bool(process.env.CHATBY_CONTACT_CLEANUP_PREVIEW_ENABLED, true),
    chatbyContactDeleteEnabled: bool(process.env.CHATBY_CONTACT_DELETE_ENABLED, false),
    releasitReturnBlockPreviewEnabled: bool(process.env.RELEASIT_RETURN_BLOCK_PREVIEW_ENABLED, true),
    releasitReturnBlockWriteEnabled: bool(process.env.RELEASIT_RETURN_BLOCK_WRITE_ENABLED, false),
