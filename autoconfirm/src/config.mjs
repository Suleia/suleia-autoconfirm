...
function defaultStoreFromEnv() {
  ...
  return {
    ...
    preparedTemplateEnabled: bool(process.env.PREPARED_TEMPLATE_ENABLED, false),
...
function withEnvOverrides(store) {
  ...
  return {
    ...
    preparedTemplateEnabled: bool(process.env.PREPARED_TEMPLATE_ENABLED, store.preparedTemplateEnabled ?? envStore.preparedTemplateEnabled),
