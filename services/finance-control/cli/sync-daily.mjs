...
import { businessDateInTimezone, runMetaAdsFinanceSpendReadCycle } from '../../meta-ads/read-cycle.mjs';
...
try {
  const result = await runMetaAdsFinanceSpendReadCycle({ config: meta, client: createMetaAdsReadClient(meta) });
  ...
  const businessDate = businessDateInTimezone(new Date(), meta.expectedTimezone);
